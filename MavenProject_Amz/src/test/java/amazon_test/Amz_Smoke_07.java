...
//Login->seraching->adding the product to wishlist->adding the product to cart->reaching till payment option UPI->logout
@Listeners (resources.TestListeners.class)

public class Amz_Smoke_07 extends Launch_Quit_Browser
{
	...
	public void login_addProd_UPI_PaymentOption_logout(String un, String pwd) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		checkout.select_UPI_Payment_rb();
