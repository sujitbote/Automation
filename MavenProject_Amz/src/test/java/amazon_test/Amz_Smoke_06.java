...
//Login->seraching->adding the product to wishlist->adding the product to cart->reaching till payment option Net Banking->logout
@Listeners (resources.TestListeners.class)

public class Amz_Smoke_06 extends Launch_Quit_Browser
{
	@Test(dataProvider="data1", dataProviderClass=resources.Fetch_Excel_Data.class)

	public void login_addProd_netBanking_PaymentOption_logout(String un, String pwd) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		checkout.select_Net_Banking_rb();
